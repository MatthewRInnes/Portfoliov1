    ...
    <section id="about" className="py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="flex items-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground dark:text-white mr-4 tracking-tight">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="animate-fade-in-up">
            <p className="text-foreground dark:text-lightSlate mb-4 font-medium leading-relaxed tracking-wide">
            ...
            <p className="text-foreground dark:text-lightSlate mb-8 font-medium leading-relaxed tracking-wide">
              Here are a few technologies I've been working with recently:
            </p>
            {/* Grid of technology items with decorative arrows */}
            <ul className="grid grid-cols-2 gap-2 text-foreground dark:text-lightSlate font-medium tracking-wide">
          ...
          <div className="grid grid-cols-2 gap-6">
            {skills.map((skill, index) => (
              ...
              >
                ...
                <h3 className="text-foreground font-semibold dark:text-white tracking-wide">{skill.name}</h3>
              </div>
            ))}
          </div>
        </div>
