      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-7">
            <p className="text-gradient-teal mb-4 animate-fade-in-up font-semibold text-lg tracking-wide">Hello! I'm</p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-foreground dark:text-white mb-6 animate-fade-in-up tracking-tight" style={{ animationDelay: '0.1s' }}>
              Matthew Innes
            </h1>
            ...
            <div className="mb-20 animate-fade-in-up h-24 md:h-28" style={{ animationDelay: '0.2s' }}>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground dark:text-lightestSlate leading-relaxed tracking-tight">
                I'm a <span className="text-gradient-teal inline-block font-semibold" style={{ lineHeight: 1.5, paddingBottom: '10px' }}>{displayText}</span>
                <span className="border-r-2 border-gradient-teal ml-1 inline-block align-text-bottom animate-pulse" style={{ height: '1em' }}></span>
              </h2>
            </div>
            
            <div className="mt-4">
              <p className="text-foreground dark:text-lightSlate max-w-xl mb-8 lg:mb-12 text-lg animate-fade-in-up leading-relaxed tracking-wide" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <Button 
                variant="outline" 
                className="border-gradient-teal text-gradient-teal hover:bg-gradient-teal/10 px-5 py-5 sm:px-6 sm:py-6 text-base sm:text-lg font-medium tracking-wide"
              ...
              <Button 
                variant="default" 
                className="bg-gradient-teal hover:bg-gradient-teal/90 text-navy px-5 py-5 sm:px-6 sm:py-6 text-base sm:text-lg font-medium tracking-wide"
