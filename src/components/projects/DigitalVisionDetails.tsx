      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <div className="aspect-video rounded-lg overflow-hidden">
            <video
              src="/assets/videos/Digital Agency Portfolio.mp4"
              controls
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <img
            ...
            alt="Digital Vision Homepage"
            className="rounded-lg shadow-lg"
          />
          <img
            src="/assets/images/digitalVision2.png"
            alt="Services Section"
            className="rounded-lg shadow-lg"
          />
          <img
            src="/assets/images/digitalVision3.png"
            alt="Portfolio Gallery"
            className="rounded-lg shadow-lg"
          />
          <img
            src="/assets/images/digitalVision5.png"
            alt="Contact Section"
            className="rounded-lg shadow-lg"
          />
        </div>
